...
import { FaStar, FaTruck, FaShieldAlt, FaHeadset } from 'react-icons/fa';

export default async function Home() {
  // Fetch products from API
  const products = await productAPI.getAll();
  
  // Get featured products (first 3 for display)
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 opacity-90">
                Explore our collection of luxury perfumes and beauty products crafted for the modern individual.
              </p>
              <div className="flex gap-4">
                <Link 
                  href="/products" 
                  className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition transform hover:scale-105"
                >
                  Shop Now
                </Link>
                <Link 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Discover our most popular fragrances and beauty essentials
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">On orders over KES 5,000</p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Genuine products guaranteed</p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
