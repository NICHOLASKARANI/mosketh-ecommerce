...
import { FaEdit, FaTrash, FaPlus, FaImage, FaSignOutAlt, FaArrowLeft } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="opacity-90">Manage your products</p>
            </div>
            <div className="flex items-center gap-4">
              <Link
                href="/"
                className="bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition flex items-center gap-2"
              >
